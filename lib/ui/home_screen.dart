...
class HomeScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder(
        stream: _firestore.collection('entries').orderBy('createdAt', descending: true).snapshots(),
              ...
              return ListTile(
                ...
                subtitle: Column(
                  ...
                  children: [
                    ...
                    Text('Created at: ${entry['createdAt'] != null ? (entry['createdAt'] as Timestamp).toDate() : 'Unknown'}'),
                  ],
                ),
                onTap: () {
                  Navigator.push(
